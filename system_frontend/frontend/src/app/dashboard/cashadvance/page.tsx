    ...
    <>
      <div className="flex flex-col">
        <div className="bg-white rounded-lg mx-5 mt-4 mb-5 p-5">
          <h3 className="text-2xl font-bold font-sans">Cash Advance Management</h3>
          <p className="ml-4 mt-2 italic">This is a Cash Advance Management were you can Generate Payroll for Specific date and see it in the table. <br /> 
