...
import OverTimeFiling from "./modal/OverTimeFiling";
    ...
    <>
      <div className="flex flex-col">
        <div className="bg-white rounded-lg mx-5 mt-4 mb-5 p-5">
          <h3 className="text-2xl font-bold font-sans">Over-Time Management</h3>
          <p className="ml-4 mt-2 italic">This is a Over-Time Management were you can Generate Payroll for Specific date and see it in the table. <br /> 
              Using Over-Time you can see the total amout to pay by selecting The Start date and End date</p>
        </div>
