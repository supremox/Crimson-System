        ...
        >
            <div className="flex flex-col p-5 gap-3">
                ...
                <div className="flex flex-row bg-white shadow-lg w-100 p-2 rounded-lg gap-4">
                    <Checkbox checked={selected === 'nodeduction'} onChange={() => handleCheckboxChange('nodeduction')} >No Deduction</Checkbox>
                    <Checkbox checked={selected === 'cutoff'}      onChange={() => handleCheckboxChange('cutoff')} >Per Cut-Off</Checkbox>
                    <Checkbox checked={selected === 'secondoff'}   onChange={() => handleCheckboxChange('secondoff')} >Second-Off</Checkbox>
                </div>
                
                <Button
                    icon={<WalletOutlined />}
                    type="primary"
                    className="h-10 mt-1 w-100 shadow-lg"
